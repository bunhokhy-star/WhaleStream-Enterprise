...
:: Runs every 4 hours starting at 06:20 BKK
::   → Picks up fresh signals 20 min after the bot runs
::   → Runs at 06:20, 10:20, 14:20, 18:20, 22:20, 02:20
:: ============================================================
echo.
echo ============================================================
...
echo   Places orders every 4 hours starting 06:20:
echo     06:20 / 10:20 / 14:20 / 18:20 / 22:20 / 02:20
echo.
echo   Signals stay valid for 4 hours after bot runs.
echo   Trader runs 20 min after bot to pick up fresh signals.
echo.
