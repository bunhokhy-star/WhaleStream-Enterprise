...
def save_memory(memory):
    ...
    # v47.68: coin_blocklist_auto.json write disabled — market decides, not static loss counts.
    # Only dynamic_blocklist.json (user-confirmed via weekly scorecard + P5 AVOID lessons) is used.
    _aged_out_longs:  list = []   # kept for safety — probation block also removed below
    _aged_out_shorts: list = []
    # v47.68: coin_blocklist_auto.json write removed — dynamic_blocklist.json handles all data-driven blocks
